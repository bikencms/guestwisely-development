	...
	<div class="row">
		<div class="col-12 col-lg-6 mb-2 mb-lg-0">
			<div class="_villas-365-property-image">
				...
				<a href="<?php echo Helpers365::MakePropertyURL($propertyPageURL, $property->slug); ?>" class="_villas-365-property-image-link unstyled-link"<?php echo $villas365PropertiesOpenInNewTabsHTML; ?>>
					<img src="<?php echo esc_html($property->image_path); ?>" alt="" class="img-fluid">
				</a>
				<?php endif; ?>
				...
				<div class="row h-100">
					<div class="col-12">
						<div class="row">
							...
							<?php if((!isset($discountsOnly) || !$discountsOnly) && !is_null($property->brief) && (trim($property->brief) !== "")) : ?>
							<div class="col-12">
								<div class="_villas-365-property-summary">
									<?php echo esc_html(Helpers365::StrLimit(Helpers365::Get365TranslationValue($property, ["brief"], ["languages", "brief"]), 375)); ?>
								</div>
							</div>
