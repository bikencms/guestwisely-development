...
$fieldLabelPriceFrom = esc_html(Helpers365::GetValueFromArray($searchTerms, "price_from", __v3t("Price From")));
		...
		<div class="row justify-content-center">
			<div class="col-12">
				<form method="GET" action="<?php echo $searchPageURL; ?>" accept-charset="UTF-8" class="_villas-365-search-form">
					<div class="row align-items-end _villas-365-date-range-container justify-content-center">
							...
							<div class="input-group chosen-input-group search-guests">
								<select name="guests" class="form-control search-text chosen-select chosen-select-single" placeholder="<?php echo $fieldLabelGuests; ?>" data-placeholder="<?php echo $fieldLabelGuests; ?>">
									...
									for($counter = 1; $counter <= $maxGuests; $counter++) :
										$selected = "";
										if(array_key_exists("guests", $searchParameters) && $searchParameters["guests"] == $counter)
										{
											$selected = " selected";
										}
									?>
						...
						<div class="col-12 col-lg-2 mb-4 mb-lg-0 px-lg-0">
							...
							?>
							<label class="d-block d-lg-none" for="price"><?php echo $fieldLabelPriceFrom; ?> (<?php __v3te($priceOptions["rate_type"]); ?>)</label>
							<div class="input-group chosen-input-group">
								<select name="price" id="price" class="form-control search-text chosen-select chosen-select-single" placeholder="<?php echo $fieldLabelPriceFrom; ?>" data-placeholder="<?php echo $fieldLabelPriceFrom; ?>">
								...
								<div class="input-group-append">
									<span class="input-group-text no-border currency-symbol"><?php echo esc_html(Helpers365::GetValueFromArray($priceOptions, "currency_symbol")); ?></span>
								</div>
							</div>
						</div>
						<div class="col-12 col-lg-auto pl-lg-0 d-none d-lg-block">
							<button type="submit" class="_villas-365-search-button btn btn-primary btn-block"><i class="fas fa-search"></i><span class="sr-only"><?php __v3te("Search"); ?></span></button>
						</div>
					</div>
