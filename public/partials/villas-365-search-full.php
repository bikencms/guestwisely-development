				...
				<div class="<?php echo $sizeContainerColumnClass; ?>">
					<div class="row align-items-end _villas-365-date-range-container justify-content-center _villas-365-field-container <?php echo $sizeClass; ?>">
						...
						<div class="<?php echo $sizeColumnClass; ?>">
							<label class="d-none" for="categoryselect"><?php echo $categoryLabel; ?></label>
							<div class="input-group chosen-input-group search-categories">
								...
								<select class="form-control search-text chosen-select chosen-select-single" placeholder="<?php echo $categoryLabel; ?>" data-placeholder="<?php echo $categoryLabel; ?>">
									<option value=""><?php echo $categoryLabel; ?></option>
									<?php
						...
						<div class="<?php echo $sizeColumnClass; ?> _villas-365-date-container">
							<label class="d-none" for="checkin"><?php echo $fieldLabelCheckIn; ?></label>
						...
						<div class="<?php echo $sizeColumnClass; ?> _villas-365-date-container">
							<label class="d-none" for="checkout"><?php echo $fieldLabelCheckOut; ?></label>
							<div class="input-group">
						...
						?>
						<div class="<?php echo $sizeColumnClass; ?>">
							<label class="d-none" for="adultguests"><?php echo $fieldLabelAdults; ?></label>
							<div class="input-group chosen-input-group search-guests">
								<select name="adultguests" class="form-control search-text chosen-select chosen-select-single" placeholder="<?php echo $fieldLabelAdults; ?>" data-placeholder="<?php echo $fieldLabelAdults; ?>">
									<option value=""><?php echo $fieldLabelAdults; ?></option>
									<?php
						...
						?>
						<div class="<?php echo $sizeColumnClass; ?>">
							<label class="d-none" for="childguests"><?php echo $fieldLabelChildren; ?></label>
							<div class="input-group chosen-input-group search-guests">
								<select name="childguests" class="form-control search-text chosen-select chosen-select-single" placeholder="<?php echo $fieldLabelChildren; ?>" data-placeholder="<?php echo $fieldLabelChildren; ?>">
									<option value=""><?php echo $fieldLabelChildren; ?></option>
									<?php
									for($counter = 1; $counter <= $maxGuests; $counter++) :
										$selected = "";
						...
						<div class="<?php echo $sizeColumnClass; ?>">
							...
							?>
							<label class="d-none" for="minprice"><?php echo $fieldLabelMinPrice; ?> (<?php __v3te($priceOptions["rate_type"]); ?>)</label>
							<div class="input-group chosen-input-group">
								...
								<div class="input-group-append">
									<span class="input-group-text currency-symbol"><?php echo esc_html($priceOptions["currency_symbol"]); ?></span>
								</div>
							</div>
						</div>
						<?php endif; ?>
						...
						<div class="<?php echo $sizeColumnClass; ?>">
							...
							$priceOptions = API365::GetPriceOptions();
							?>
							<label class="d-none" for="maxprice"><?php echo $fieldLabelMaxPrice; ?> (<?php __v3te($priceOptions["rate_type"]); ?>)</label>
							<div class="input-group chosen-input-group">
						...
						?>
						<div class="<?php echo $sizeColumnClass; ?>">
							<label class="d-none" for="bathrooms"><?php echo $fieldLabelBathrooms; ?></label>
							<div class="input-group chosen-input-group">
								...
								<div class="input-group-append">
									<span class="input-group-text"><i class="fas fa-fw fa-bath"></i></span>
								</div>
							</div>
						</div>
						<?php endif; ?>
						...
						?>
						<div class="<?php echo $sizeColumnClass; ?>">
							<label class="d-none" for="bedrooms"><?php echo $fieldLabelBedrooms; ?></label>
							<div class="input-group chosen-input-group">
								...
								<div class="input-group-append">
									<span class="input-group-text"><i class="fas fa-fw fa-bed"></i></span>
								</div>
							</div>
						</div>
						<?php endif; ?>
						...
						?>
						<div class="<?php echo $sizeColumnClass; ?>">
							<label class="d-none" for="city"><?php echo $fieldLabelCity; ?></label>
							<div class="input-group chosen-input-group">
								<select name="city" class="form-control search-text chosen-select chosen-select-single" placeholder="<?php echo $fieldLabelCity; ?>" data-placeholder="<?php echo $fieldLabelCity; ?>">
									<option value=""><?php echo $fieldLabelCity; ?></option>
									<?php
						...
						if(($firstRowFieldCount != $firstRowMaxFieldCount) && !in_array("show_tags_filter", $firstRowShownFields) && Helpers365::GetValueFromArray($searchSettings, ["fields", "show_tags_filter"])):
							...
							<div class="<?php echo $sizeColumnClass; ?>">
								<label class="d-none" for="tag_id"><?php echo $tagsLabel; ?></label>
						...
						?>
						<div class="<?php echo $sizeColumnClass; ?>">
							<label class="d-none" for="q"><?php echo $fieldLabelKeywords; ?></label>
							<div class="input-group">
								<input name="q" type="text" class="form-control" value="<?php echo esc_html($searchParameters["q"]); ?>" placeholder="<?php echo $fieldLabelKeywords; ?>">
								<div class="input-group-append">
						...
						<div class="<?php echo $sizeColumnClass; ?> mt-2 mt-md-0">
							<div class="d-flex">
								<?php if($showFilter) : ?>
								<button type="button" class="_villas-365-search-button _villas-365-filter-button btn btn-primary"><i class="fas fa-fw fa-sliders-h"></i><span class="sr-only"><?php __v3te("Filter"); ?></span></button>
								<?php endif; ?>
								<button type="submit" class="_villas-365-search-button btn btn-primary"><?php __v3te("Search"); ?></button>
							</div>
						</div>
					</div>
				</div>
