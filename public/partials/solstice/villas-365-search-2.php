...
wp_enqueue_script('_villas-365-bootstrap-scripts', plugin_dir_url( __FILE__ ) . "../../assets/solstice/js/villas-365-datepicker.js", ['jquery'], "1.0.0", true);
...
wp_enqueue_style('_villas-365-styles', plugin_dir_url( __FILE__ ) . "../../assets/solstice/css/villas-365-styles.css", ["_villas-365-chosen", "_villas-365-fontawesome", "_villas-365-datepicker-styles"], "1.0");
wp_enqueue_script('_villas-365-scripts', plugin_dir_url( __FILE__ ) . '../../assets/solstice/js/villas-365-scripts.js', ['jquery', '_villas-365-bootstrap-scripts'], "1.0", true);
		...
		<div class="row justify-content-center">
			<div class="col">
				<form method="GET" action="<?php echo $searchPageURL; ?>" accept-charset="UTF-8" class="_villas-365-search-form">
					<div class="row _villas-365-date-range-container">
