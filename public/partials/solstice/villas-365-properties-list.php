...
wp_enqueue_style('_villas-365-styles', plugin_dir_url( __FILE__ ) . "../../assets/solstice/css/villas-365-styles.css", [], "1.0");
wp_enqueue_style('_villas-365-properties-list', plugin_dir_url( __FILE__ ) . "../../assets/solstice/css/villas-365-properties-list.css", ["_villas-365-styles"], "1.0");
wp_enqueue_script('_villas-365-scripts', plugin_dir_url( __FILE__ ) . '../../assets/solstice/js/villas-365-scripts.js', ['jquery', '_villas-365-googlemaps'], "1.0", true);
wp_enqueue_script('_villas-365-properties-list-scripts', plugin_dir_url( __FILE__ ) . '../../assets/solstice/js/villas-365-properties-list.js', ['_villas-365-scripts'], "1.0", true);
