...
wp_enqueue_script('_villas-365-datepicker-scripts', plugin_dir_url( __FILE__ ) . "../../assets/template-1/js/villas-365-datepicker.js", ['jquery'], "1.0.0", true);
...
wp_enqueue_style('_villas-365-styles', plugin_dir_url( __FILE__ ) . "../../assets/template-1/css/villas-365-styles.css", ["_villas-365-fontawesome", "_villas-365-fancybox-styles", "_villas-365-chosen",  "_villas-365-datepicker-styles"], "1.0");
wp_enqueue_style('_villas-365-property-styles', plugin_dir_url( __FILE__ ) . "../../assets/template-1/css/villas-365-property.css", ["_villas-365-styles"], "1.0");
wp_enqueue_script('_villas-365-bootstrap', plugin_dir_url( __FILE__ ) . "../../assets/template-1/libs/bootstrap.js", ["jquery"], "4.1.1", true);
...
wp_enqueue_script('_villas-365-scripts', plugin_dir_url( __FILE__ ) . '../../assets/template-1/js/villas-365-scripts.js', ['jquery', '_villas-365-bootstrap', "_villas-365-fancybox-scripts", "_villas-365-datepicker-scripts"], "1.0", true);
wp_enqueue_script('_villas-365-property-scripts', plugin_dir_url( __FILE__ ) . '../../assets/template-1/js/villas-365-property.js', ['jquery', '_villas-365-scripts'], "1.0", true);
						...
						<div class="_property-image-overlay">
							<div class="_property-image-overlay-content">
								<div class="_property-image-overlay-image">
									<img src="<?php echo plugins_url('../../assets/template-1/img/virtual-tour.svg', __FILE__); ?>" alt="">
								</div>
