 ...
 *
 * @link              https://www.365villas.com
 * @since             2.7.47
 * @package           Villas_365
 *
 * @wordpress-plugin
 * Plugin Name:       365villas
 * Plugin URI:        https://www.365villas.com
 * Description:       Adds various functions related to 365villas.
 * Version:           2.7.47
 * Author:            LoyaltyMATTERS
 * Author URI:        https://loyaltymatters.co.uk
 * License:           Copyright (C) 2018 365villas.
 * Text Domain:       villas-365
 ...
 */
define( 'VILLAS_365_VERSION',  '2.7.47' );
...
$apiClass = str_replace('Vcs_PluginUpdateChecker', 'Vcs_GitLabApi', $checkerClass); // \Puc_v4p11_Vcs_GitLabApi
$myUpdateChecker = new $checkerClass(
    new $apiClass('https://gitlab.365villas.com/365villas-wordpress/365villas-wordpress-plugin-release/'),
		__FILE__,
		'villas-365'
);
$myUpdateChecker->setAuthentication('glpat-Z1zZgRdMVMFRxHbbmZ8Z');  
